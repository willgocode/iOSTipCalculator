...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified tipField;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)endEditing:(id _Nonnull)sender;
- (IBAction)updateDefaults:(id _Nonnull)sender;
...
- (IBAction)tipControlChange:(id _Nonnull)sender;
- (IBAction)calculateTip:(id _Nonnull)sender;
- (IBAction)returnToMainWithSegue:(UIStoryboardSegue * _Nonnull)segue;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
